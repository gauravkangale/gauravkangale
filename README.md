...
<details>
  <summary>ᴄᴏᴜʀꜱᴇꜱ ᴏᴠᴇʀ ᴡɪᴛʜ</summary>

- 🎗️

  <details>
    <summary>ᴜɴɪᴠᴇʀꜱɪᴛʏ ᴄᴏᴜʀꜱᴇꜱ</summary>
  ...
  <details>
    <summary>ᴍᴇᴛᴀ ɪᴏꜱ ᴅᴇᴠᴇʟᴏᴘᴇʀ</summary>
  ...
  <details>
    <summary>ɢᴏᴏɢʟᴇ ᴅᴀᴛᴀ ᴀɴᴀʟʏᴛɪᴄꜱ</summary>
  ...
  <details>
    <summary>ᴀᴅᴠᴀɴᴄᴇᴅ ᴅᴀᴛᴀ ᴀɴᴀʟʏᴛɪᴄꜱ</summary>
...
<div align="center">
  <br>
  <p>
    <a target="_blank" href="https://www.canva.com/" title="Canva for Design">
      <img alt="Canva" height="52" src="https://img.icons8.com/color/96/canva.png">
    </a>
    <a target="_blank" href="https://www.figma.com/" title="Figma for UI/UX Design">
      <img alt="Figma" height="52" src="https://img.icons8.com/color/96/figma--v1.png">
    </a>
    <a target="_blank" href="https://code.visualstudio.com/" title="Visual Studio Code">
      <img alt="VS Code" height="52" src="https://img.icons8.com/color/96/visual-studio-code-2019.png">
    </a>
    <a target="_blank" href="https://github.com/" title="GitHub">
      <img alt="GitHub" height="52" src="https://img.icons8.com/ios-glyphs/96/github.png">
    </a>
    <a target="_blank" href="https://gitlab.com/" title="GitLab">
      <img alt="GitLab" height="52" src="https://img.icons8.com/color/96/gitlab.png">
    </a>
    <a target="_blank" href="https://bitbucket.org/" title="Bitbucket">
      <img alt="Bitbucket" height="52" src="https://img.icons8.com/color/96/bitbucket.png">
    </a>
    <a target="_blank" href="https://www.postman.com/" title="Postman API Platform">
      <img alt="Postman" height="52" src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/96/external-postman-is-the-only-complete-api-development-environment-logo-color-tal-revivo.png">
    </a>
    <a target="_blank" href="https://www.docker.com/" title="Docker Container Platform">
      <img alt="Docker" height="52" src="https://img.icons8.com/color/96/docker.png">
    </a>
    <a target="_blank" href="https://kubernetes.io/" title="Kubernetes Container Orchestration">
      <img alt="Kubernetes" height="52" src="https://img.icons8.com/color/96/kubernetes.png">
    </a>
    <a target="_blank" href="https://www.jenkins.io/" title="Jenkins CI/CD">
      <img alt="Jenkins" height="52" src="https://img.icons8.com/color/96/jenkins.png">
    </a>
    <a target="_blank" href="https://www.github.com/features/actions" title="GitHub Actions CI/CD">
      <img alt="GitHub Actions" height="52" src="https://img.icons8.com/color/96/github.png">
    </a>
    <a target="_blank" href="https://vercel.com/" title="Vercel Deployment Platform">
      <img alt="Vercel" height="52" src="https://img.icons8.com/ios-filled/96/vercel.png">
    </a>
    <a target="_blank" href="https://www.netlify.com/" title="Netlify Hosting">
      <img alt="Netlify" height="52" src="https://img.icons8.com/color/96/netlify.png">
    </a>
    <a target="_blank" href="https://aws.amazon.com/" title="Amazon Web Services">
      <img alt="AWS" height="52" src="https://img.icons8.com/color/96/amazon-web-services.png">
    </a>
    <a target="_blank" href="https://cloud.google.com/" title="Google Cloud Platform">
      <img alt="GCP" height="52" src="https://img.icons8.com/color/96/google-cloud.png">
    </a>
    <a target="_blank" href="https://azure.microsoft.com/" title="Microsoft Azure">
      <img alt="Azure" height="52" src="https://img.icons8.com/color/96/azure-1.png">
    </a>
    <a target="_blank" href="https://supabase.com/" title="Supabase Backend Platform">
      <img alt="Supabase" height="52" src="https://img.icons8.com/color/96/supabase.png">
    </a>
    <a target="_blank" href="https://firebase.google.com/" title="Firebase Backend Services">
      <img alt="Firebase" height="52" src="https://img.icons8.com/color/96/firebase.png">
    </a>
    <a target="_blank" href="https://www.mongodb.com/" title="MongoDB Database">
      <img alt="MongoDB" height="52" src="https://img.icons8.com/color/96/mongodb.png">
    </a>
    <a target="_blank" href="https://www.mysql.com/" title="MySQL Database">
      <img alt="MySQL" height="52" src="https://img.icons8.com/color/96/mysql-logo.png">
    </a>
    <a target="_blank" href="https://www.postgresql.org/" title="PostgreSQL Database">
      <img alt="PostgreSQL" height="52" src="https://img.icons8.com/color/96/postgreesql.png">
    </a>
    <a target="_blank" href="https://redis.io/" title="Redis Cache">
      <img alt="Redis" height="52" src="https://img.icons8.com/color/96/redis.png">
    </a>
    <a target="_blank" href="https://www.notion.so/" title="Notion Workspace">
      <img alt="Notion" height="52" src="https://img.icons8.com/ios-filled/96/notion.png">
    </a>
    <a target="_blank" href="https://slack.com/" title="Slack Communication">
      <img alt="Slack" height="52" src="https://img.icons8.com/color/96/slack.png">
    </a>
    <a target="_blank" href="https://www.atlassian.com/software/jira" title="Jira Project Management">
      <img alt="Jira" height="52" src="https://img.icons8.com/color/96/jira.png">
    </a>
    <a target="_blank" href="https://trello.com/" title="Trello Task Management">
      <img alt="Trello" height="52" src="https://img.icons8.com/color/96/trello.png">
    </a>
    <a target="_blank" href="https://www.npmjs.com/" title="npm Package Manager">
      <img alt="npm" height="52" src="https://img.icons8.com/color/96/npm.png">
    </a>
    <a target="_blank" href="https://www.typescriptlang.org/" title="TypeScript Language">
      <img alt="TypeScript" height="52" src="https://img.icons8.com/color/96/typescript.png">
    </a>
